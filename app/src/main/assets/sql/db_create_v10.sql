...
CREATE TABLE "Inseminacao"(
  "idInseminacao" INTEGER PRIMARY KEY NOT NULL,
  "Descricao" VARCHAR(100)
);
CREATE TABLE "Animal"(
...
CREATE TABLE "Animal_Inseminacao"(
  ...
  "Animal_idAnimal" INTEGER NOT NULL,
  "data" DATE NOT NULL,
  CONSTRAINT "fk_Vaca_Inseminacao_Inseminacao1"
    FOREIGN KEY("Inseminacao_idInseminacao")
    REFERENCES "Inseminacao"("idInseminacao"),
  CONSTRAINT "fk_Animal_Inseminacao_Animal1"
    FOREIGN KEY("Animal_idAnimal")
    REFERENCES "Animal"("idAnimal")
);
CREATE INDEX "Animal_Inseminacao.fk_Vaca_Inseminacao_Inseminacao1_idx" ON "Animal_Inseminacao" ("Inseminacao_idInseminacao");
...
CREATE TABLE "Responsavel_por"(
  "idResponsavel_por" INTEGER PRIMARY KEY NOT NULL,
  "Inseminacao_idInseminacao" INTEGER NOT NULL,
  "Usuario_idUsuario" INTEGER NOT NULL,
  CONSTRAINT "fk_Responsavel_por_Inseminacao1"
    FOREIGN KEY("Inseminacao_idInseminacao")
    REFERENCES "Inseminacao"("idInseminacao"),
  CONSTRAINT "fk_Responsavel_por_Usuario1"
    FOREIGN KEY("Usuario_idUsuario")
    REFERENCES "Usuario"("idUsuario")
);
CREATE INDEX "Responsavel_por.fk_Responsavel_por_Inseminacao1_idx" ON "Responsavel_por" ("Inseminacao_idInseminacao");
CREATE INDEX "Responsavel_por.fk_Responsavel_por_Usuario1_idx" ON "Responsavel_por" ("Usuario_idUsuario");
