...
CREATE TABLE  "Administrador_Notifica_Pessoa"(
  ...
  "Pessoa_idNotificado" INTEGER NOT NULL,
  "Administrador_idNotifica" INTEGER NOT NULL,
  "data" DATE NOT NULL,
  "descricao" VARCHAR(100) NOT NULL,
  CONSTRAINT "fk_Administrador_Notifica_Pessoa_Administrador2"
    FOREIGN KEY("Pessoa_idNotificado")
    REFERENCES "Pessoa"("idPessoa"),
...
CREATE INDEX  "Administrador_Notifica_Pessoa.fk_Administrador_Notifica_Pessoa_Administrador2_idx" ON "Administrador_Notifica_Pessoa" ("Pessoa_idNotificado");
